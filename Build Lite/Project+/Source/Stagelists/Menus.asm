...
string "/menu2/az_menumain.pac"         @ $806FB248
string "az_menumain_en.pac"             @ $817F62BC
string "/menu2/az_selcharacter2.pac"    @ $806FF308
string "az_selcharacter2_en.pac"        @ $817F634D
string "/menu2/az_selmap.pac"           @ $806FF3F0
string "az_selmap_en.pac"               @ $817F637C
string "stageslotaz/"                   @ $80550B08 # This address might change and crash
string "stageinfo/"                     @ $80550B18 # This address might change and crash
* E0000000 80008000